...
export async function GET(request: Request) {
  const actionMedata: ActionGetResponse = {
    ...
    description: `Challenges are cool right but it becomes more intense when some money 
      ...
      init with your valid accountID send the link of the blink for that challenge to you friend. After that we
      will check you next X number of TDM matches with each other and who wins more of them will wint he challenge 
      and entry fee of other will send to the winner. 
          We will start watching the matches result when the second participant
          particpate
